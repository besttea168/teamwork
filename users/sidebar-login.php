<aside class="left-aside bg-dark border-end border-secondary vh-100 position-fixed top-0 start-0 overflow-auto">
    <div class="accordion accordion-flush" id="accordionFlushExample">
            ...
            <div id="flush-collapseUser" class="accordion-collapse collapse" aria-labelledby="flush-headingUser" data-bs-parent="#accordionFlushExample">
                <div class="accordion-body bg-dark">
                    <div class="list-group text-center">
                        <a href="creat-user.php" class="list-group-item list-group-item-action">註冊帳號</a>
                        <a href="users.php" class="list-group-item list-group-item-action">會員資料</a>
                        <a href="deleted-users.php" class="list-group-item list-group-item-action">已封鎖會員</a>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="accordion-item">
            ...
            <div id="flush-collapseArticle" class="accordion-collapse collapse" aria-labelledby="flush-headingArticle" data-bs-parent="#accordionFlushExample">
                <div class="accordion-body bg-dark">
                    <div class="list-group text-center">
                        <a href="" class="list-group-item list-group-item-action">文章列表</a>
                        <a href="" class="list-group-item list-group-item-action">新增文章</a>
                    </div>
                </div>
            </div>
        </div> -->
