...
if (isset($_GET["search"])) {
    ...
    header("location:delete-video.php?p=1&order=1");
}
        ...
        <div class="container py-4  ">
                ...
                <div class=" py-3">
                    <div class="btn-group py-2  ">
                        <?php if (isset($_GET["search"])) : ?>
                            <a class="btn btn-primary mx-3 rounded-2" href="delete-video.php" title="回軟刪除影片列表"><i class="fa-solid fa-left-long"></i></a>
                        <?php endif; ?>
            ...
            ?>
                ...
                <div class="container form-control border-0  px-0">
                    ...
                    <?php if ($order == 1) echo "active" ?>" href="delete-video.php?p=<?= $page ?>&order=1">
                                                <i class="fa-solid fa-arrow-down-short-wide fa-xs"></i>
                                            </a>
                                            <a class="btn border-0 btn-secondary
                    <?php if ($order == 2) echo "active" ?>
                    " href="delete-video.php?p=<?= $page ?>&order=2">
                        ...
                        <tbody>
                            <?php foreach ($pagedRows as $row) : ?>
                                <tr class="text-center">
                                    ...
                                    <td>
                                        <a class="btn btn-primary" href="doreverse-video.php?id=<?= $row["id"] ?>" onclick="return confirm('確定恢復這支影片嗎?')"><i class="fa-solid fa-rotate-left"></i></a>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
                        </tbody>
