                        ...
                        <form action="doUpdateProduct.php" method="post" enctype="multipart/form-data">
                            <table class="table table-bordered">
                                ...
                                <tr>
                                    <th>建議最少遊玩人數</th>
                                    <td>
                                        <input type="text" class="form-control" name="min_users" value="<?= $row["min_users"] ?>">
                                    </td>
                                </tr>
                                <tr>
                                    <th>建議最多遊玩人數</th>
                                    <td>
                                        <input type="text" class="form-control" name="max_users" value="<?= $row["max_users"] ?>">
                                    </td>
                                </tr>
                                <tr>
                                    <th>建議最小遊玩年齡</th>
                                    <td>
                                        <input type="text" class="form-control" name="min_age" value="<?= $row["min_age"] ?>">
                                    </td>
                                </tr>
                                <tr>
                                    <th>預計遊玩時間</th>
