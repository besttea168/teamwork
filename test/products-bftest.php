...
if (isset($_GET["search"])) {
    ...
    switch($order){
        case 1:
            $sql = "SELECT * FROM product WHERE valid = 1 ORDER BY name ASC LIMIT $start_item, $per_page";
            break;
    }
...
<body>
    <div class="container">
        ...
        <div class="py-2 d-flex justify-content-end">
            <div class="btn-group">
                <a class="btn btn-primary" href="products.php?p=<?=$page?>&order=1">name 小到大</a>
                <a class="btn btn-primary" href="products.php?p=<?=$page?>&order=2">name 大到小</a>
            </div>
        </div>
