...
if (isset($_GET["search"])) {
    ...
    $sql = "SELECT product.*, 
            ...
            WHERE (product.name LIKE '%$search%' || product.category_tag LIKE '%$search%') AND product.valid=1
            GROUP BY product.id";
            ...
            <div class="py-2">
                <form action="">
                    <div class="input-group">
                        <input type="search" class="form-control" name="search" placeholder="搜尋商品或類別" value="<?php echo isset($_GET["search"]) ? $_GET["search"] : "" ?>">
